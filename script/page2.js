...
<h3 id="name">${element.nome}</h3>
<span id="cpf">${element.cpf}</span>
<span id="telefone">${element.telefone}</span>
<span id="email">${element.email}</span>
</div>
</div>  
        `
        cards.insertAdjacentHTML("beforeend", cartao)
